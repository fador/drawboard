//http://boxmonster.890m.com/wordpress/?p=123
...
package {
	...
	public class piirto extends MovieClip
    {
        ...
        private function updateBrushArray():void
        {
            ...
            if (brush == 0) brushShapeArray[0].graphics.lineStyle(2, 0, 1);
            else brushShapeArray[0].graphics.lineStyle(1, 0, 1);  
            ...
            for (i = 1; i < 11; i++)
            {
                ...
                if (brush == i) brushShapeArray[i].graphics.lineStyle(2, 0, 1);
                else brushShapeArray[i].graphics.lineStyle(1, 0, 1);
        ...
        private function updateColorArray():void
        {
            ...
            for (i = 0; i < 9; i++)
            {
                ...
                if (currentColor == i) colorShapeArray[i].graphics.lineStyle(2, 0, 1);
                else colorShapeArray[i].graphics.lineStyle(1, 0, 1);
        ...
        private function md(event:MouseEvent):void
        {
            ...
            if (isInBrushChange(event.stageX, event.stageY))
                return;
            if (event.stageX > colorMapPlaceX && event.stageX < colorMapPlaceX + 260 && event.stageY > colorMapPlaceY
                && event.stageY < colorMapPlaceY+40)
            {
                colorSelecting=true;
		...
		private function mm(event:MouseEvent):void
        {
            ...
            if (colorSelecting &&
                event.stageX > colorMapPlaceX && event.stageX < colorMapPlaceX + 260 &&
                event.stageY > colorMapPlaceY && event.stageY < colorMapPlaceY+40)
            {              
                colorField.text=dec2hex(colorMap.getPixel(event.stageX-colorMapPlaceX,event.stageY-colorMapPlaceY));
                colorChange(null);
            }
